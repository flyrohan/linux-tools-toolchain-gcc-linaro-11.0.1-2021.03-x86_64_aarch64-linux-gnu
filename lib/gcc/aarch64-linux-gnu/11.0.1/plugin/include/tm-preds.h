/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/tcwg-buildslave/workspace/tcwg-dev-build/snapshots/gcc.git~master/gcc/config/aarch64/aarch64.md'.  */
...
extern int aarch64_simd_shift_imm_vec_qi (rtx, machine_mode);
extern int aarch64_simd_shift_imm_vec_hi (rtx, machine_mode);
extern int aarch64_simd_shift_imm_vec_si (rtx, machine_mode);
extern int aarch64_simd_shift_imm_vec_di (rtx, machine_mode);
